...
class BrowseCategory extends StatefulWidget {
  final void Function(CategoryModel model) onSelected;
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: TextboxSearch(
                                ...
                                onChanged: (value) {
                                  categoryController.searchData(value);
                                },
                              ),
                            ),
                            // const SizedBox(
                              ...
                              child: ListView.builder(
                                ...
                                itemBuilder: ((context, index) =>
                                    GestureDetector(
                                      onTap: () {
                                        setState(() {
                                          selectCategory(categoryController
                                              .listOfCategory[index]);
                                        });
                                        if (widget.multiSelect == false) {
                                          widget.onSelected(categoryController
                                              .listOfCategory[index]);
                                          Navigator.pop(context);
                                        } else {
                                          widget.onSelected(categoryController
